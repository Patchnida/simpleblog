...
const LoginForm = () => {
  ...
  return (
    <div className="w-full min-w-80 lg:max-w-2xl ">
        <div className="flex flex-col justify-center items-center bg-white w-full  px-5 md:px-10 py-14 md:py-36 lg:py-16 gap-5 md:gap-10 lg:gap-7 shadow">
            ...
            <button className="bg-zinc-950 text-white text-base lg:text-lg font-medium px-5 py-2 w-11/12 lg:py-3 border flex justify-center items-center self-center my-2 hover:shadow hover:bg-zinc-800">LOGIN</button>
            <div>
