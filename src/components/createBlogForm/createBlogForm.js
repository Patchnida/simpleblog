...
const CreateBlogForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const writerImg = session?.user?.img || '/noavatar.png'; // Use default avatar if no image
    ...
    try {
      ...
      const res = await fetch('/api/blogs', {
        ...
        body: JSON.stringify({ title, category, desc, writer, img: imgUrl, writerImg:user.img }),
      });
